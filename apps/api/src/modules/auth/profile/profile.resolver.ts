...
export class ProfileResolver {
  ...
  public async changeColor(
    ...
    @Args('data') input: ChangeProfileColorInput,
  ) {
    return this.profileService.changeColor(user, input);
  }

  @Authorization()
  @Mutation(() => Boolean, {
    name: 'changeProfileAvatar',
  })
