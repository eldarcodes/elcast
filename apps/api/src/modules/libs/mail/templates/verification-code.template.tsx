        ...
        <Body className="max-w-2xl mx-auto p-6 bg-slate-50">
          <Section className="text-center mb-8">
            ...
            <Text className="text-base text-black">
              We received a request to change your account Email at{' '}
              <b>Elcast</b>. If you initiated this request, please use the
              confirmation code below to verify your email address.
            </Text>
